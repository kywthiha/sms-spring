...
class ThreadAdapter(
    activity: _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SimpleActivity, var messages: ArrayList<ThreadItem>, recyclerView: MyRecyclerView, fastScroller: FastScroller,
    itemClick: (Any) -> Unit
