...
class ConversationsAdapter(activity: _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SimpleActivity, var conversations: ArrayList<Conversation>, recyclerView: MyRecyclerView, fastScroller: FastScroller,
