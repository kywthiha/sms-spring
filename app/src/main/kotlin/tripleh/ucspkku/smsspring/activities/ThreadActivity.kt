...
class ThreadActivity : _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SimpleActivity() {
    ...
    private fun setupAdapter() {
        ...
        runOnUiThread {
            ...
            if (currAdapter == null) {
                _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ThreadAdapter(
                    this,
                    threadItems,
                ...
                (currAdapter as _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ThreadAdapter).updateMessages(threadItems)
            }
        }
        ...
        SimpleContactsHelper(this).getAvailableContacts(false) { contacts ->
            ...
            runOnUiThread {
                val adapter =
                    _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.AutoCompleteTextViewAdapter(
                        this,
                        contacts
                    )
                ...
                add_contact_or_number.setOnItemClickListener { _, _, position, _ ->
                    val currContacts = (add_contact_or_number.adapter as _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.AutoCompleteTextViewAdapter).resultList
    ...
    private fun setupButtons() {
        ...
        confirm_manage_contacts.setOnClickListener {
            ...
            if (threadId != newThreadId) {
                Intent(this, _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.ThreadActivity::class.java).apply {
    ...
    private fun sendMessage() {
        ...
        try {
            ...
            transaction.sendNewSmsMessage(message,config.addRegexFilter,config.customizeSplitLength, threadId)
