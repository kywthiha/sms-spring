...
class NewConversationActivity : _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SimpleActivity() {
    ...
    private fun setupAdapter(contacts: ArrayList<SimpleContact>) {
        ...
        if (currAdapter == null) {
            _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ContactsAdapter(
                this,
                contacts,
                contacts_list,
                null
            ...
            (currAdapter as _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ContactsAdapter).updateContacts(contacts)
        }
