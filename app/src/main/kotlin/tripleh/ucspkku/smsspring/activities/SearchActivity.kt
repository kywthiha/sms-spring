...
class SearchActivity : _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SimpleActivity() {
    ...
    private fun showSearchResults(messages: List<Message>, conversations: List<Conversation>, searchedText: String) {
        ...
        runOnUiThread {
            ...
            if (currAdapter == null) {
                _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.SearchResultsAdapter(
                    this,
                    searchResults,
                    search_results_list,
                    searchedText
                ...
                (currAdapter as _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.SearchResultsAdapter).updateItems(searchResults, searchedText)
            }
        }
    }
}
