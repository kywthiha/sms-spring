...
class MainActivity : _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SimpleActivity() {
    ...
    override fun onResume() {
        ...
        if (storedTextColor != config.textColor) {
            (conversations_list.adapter as? _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ConversationsAdapter)?.updateTextColor(config.textColor)
        }

        if (storedFontSize != config.fontSize) {
            (conversations_list.adapter as? _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ConversationsAdapter)?.updateFontSize()
        }
    ...
    private fun setupConversations(conversations: ArrayList<Conversation>) {
        ...
        if (currAdapter == null) {
            _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ConversationsAdapter(
                this,
                conversations,
                conversations_list,
                ...
                Intent(
                    this,
                    _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.ThreadActivity::class.java
                ).apply {
            ...
            conversations_fastscroller.setViews(conversations_list) {
                val listItem = (conversations_list.adapter as? _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ConversationsAdapter)?.conversations?.getOrNull(it)
                conversations_fastscroller.updateBubbleText(listItem?.title ?: "")
            }
        } else {
            try {
                (currAdapter as _root_ide_package_.tripleh.ucspkku.smsmessenger.adapters.ConversationsAdapter).updateConversations(conversations)
    ...
    private fun launchNewConversation() {
        Intent(this, _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.NewConversationActivity::class.java).apply {
            startActivity(this)
        }
    }
    ...
    private fun getCreateNewContactShortcut(appIconColor: Int): ShortcutInfo {
        ...
        val intent = Intent(this, _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.NewConversationActivity::class.java)
    ...
    private fun launchSearch() {
        startActivity(Intent(applicationContext, _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SearchActivity::class.java))
    }

    private fun launchSettings() {
        startActivity(Intent(applicationContext, _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.SettingsActivity::class.java))
    }
