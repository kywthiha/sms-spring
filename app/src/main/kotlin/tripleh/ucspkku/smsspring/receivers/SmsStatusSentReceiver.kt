package tripleh.ucspkku.smsmessenger.receivers
...
class SmsStatusSentReceiver : SentReceiver() {
    ...
    private fun showNotification(context: Context, recipientName: String, threadId: Long) {
        ...
        val intent = Intent(context, _root_ide_package_.tripleh.ucspkku.smsmessenger.activities.ThreadActivity::class.java).apply {
